...
static void MyTask2(void* pvParameters)
{
  ...
  { 
    int a=sizeof(int);
    Serial.println("Size of int data type");
    Serial.println(a);
    a=sizeof(unsigned int);
    Serial.println("Size of unsigned int data type");
    Serial.println(a);
    a=sizeof(short);
    Serial.println("Size of short data type");
    Serial.println(a);
    a=sizeof(char);
    Serial.println("Size of char data type");
    Serial.println(a);
    a=sizeof(float);
    Serial.println("Size of float data type");
    Serial.println(a);
